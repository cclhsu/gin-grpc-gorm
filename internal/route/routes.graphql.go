...
// func SetupGraphQLRoutes(r *gin.Engine, host string, port string, logger *logrus.Logger, authService *service.AuthService, userService *service.UserService, helloService *service.HelloService, healthService *service.HealthService) {
